...
| `web-app` | same as `optimized` for now; future web workflow tools may prioritize TypeScript, JavaScript, React, Next.js, Angular, Node.js, REST APIs, routes, and components | 7 |

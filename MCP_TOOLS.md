...
| `web-app` | same as `optimized` for now; future web workflow tools may prioritize TypeScript, JavaScript, C#, ASP.NET Core, React, Next.js, Angular, Node.js, REST APIs, routes, components, data access metadata, and realtime/socket metadata | 7 |
